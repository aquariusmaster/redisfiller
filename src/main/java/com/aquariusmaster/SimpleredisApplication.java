...
public class SimpleredisApplication {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(SimpleredisApplication.class);
	...
	public static void main(String[] args) {
		ApplicationContext ctx = SpringApplication.run(SimpleredisApplication.class, args);
	...
	public void scheduler(){
		...
		List<Record> records = XMLRecordReader.readRecordFromXML(50, environment.getProperty("redis.data"));
